package com.daviarimateia.dsimpledao.dao.jdbc;
...
import com.daviarimateia.dsimpledao.annotation.Generated;
import com.daviarimateia.dsimpledao.annotation.Group;
import com.daviarimateia.dsimpledao.annotation.Identifier;
import com.daviarimateia.dsimpledao.annotation.TableName;
import com.daviarimateia.dsimpledao.dao.GenericDAO;
import com.daviarimateia.dsimpledao.factory.DAOFactory;
import com.daviarimateia.dsimpledao.utils.MapHelper;
...
public abstract class JDBCGenericDAO<T extends Serializable> implements GenericDAO<T>
{
	...
	protected PreparedStatement createPreparedStatement(Connection connection, String sql, Object[] args, int autoGeneratedKeys)
	{
