...
import com.daviarimateia.dsimpledao.dao.filter.DAOFilter;
import com.daviarimateia.dsimpledao.dao.jdbc.JDBCGenericDAO;
import com.daviarimateia.dsimpledao.factory.DAOFactory;

public abstract class MySQLGenericDAO<T extends Serializable> extends JDBCGenericDAO<T>
{
	protected MySQLGenericDAO()
	{
		super(DAOFactory.Type.MYSQL);
	}
